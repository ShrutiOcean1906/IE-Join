...
public class BufMgr implements GlobalConst{
   ...
   */
  // Buffer manager constructor to accept the value of K 
  public BufMgr( int numbufs, String replacerArg, int k)
    {
   ...
   * @param replacerArg name of the buffer replacement policy.
   */
  // Modified existing buffermanager constructor to support LRUK, LIFO and FIFO replacement policy
  ...
  // To get object of Replacer in TEST 4
