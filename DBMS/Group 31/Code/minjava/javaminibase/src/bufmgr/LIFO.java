...
import global.*;
   ...
   */
   /*
   * LIFO class same as that of MRU except it does not update the frames array 
   * when it pins already existing page and when it pins tha given page when not present in buffer pool 
   */
